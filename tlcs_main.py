...
#**tlcs_main.py**. It basically handles the main loop that starts an episode on every iteration. At the end it saves the network and it also save 3 graphs: negative reward, cumulative delay and average queues. 
...
if __name__ == "__main__":
    ...
    batch_size = 200
    memory_size = 50000
    path = "./model/model_best_100e_05g_batch_200/"  # nn = best, episodes = 100, gamma = 0.5
    # ----------------------

    # attributes of the agent
    num_states = 80
    num_actions = 4
    max_steps = 2500  # seconds = 42 min each episode
    green_duration = 5
    yellow_duration = 2
